...
public class AlbumActivity extends PlayerActivity implements RadioPlayerListener {

    private List<Album> albumList = new ArrayList<Album>();
    Boolean ascending = true;

    private AlbumPlayer player;
    ...
    private void createPlayer()
    {
        try
        {
            player = new AlbumPlayer(getApplication(), deezerConnect, NetworkStateCheckerFactory.wifiAndMobile());
    ...
    private void getUserArtists() {
        RequestListener listener = new JsonRequestListener() {
            ...
            public void onResult(Object result, Object requestId) {
                albumList = (ArrayList<Album>) result;
                for (Album album : albumList) {
                    items.add(new ListItem(album.getTitle(), album.getBigImageUrl(), album.getId()));
                }
                adapter = new ListAdapter(AlbumActivity.this, items);
                ...
                listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                    ...
                    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        String shareMessage= "\nShare?\n\n";
                        shareMessage = shareMessage + album.getLink() + BuildConfig.APPLICATION_ID +"\n\n";
